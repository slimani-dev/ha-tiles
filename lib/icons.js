...
export class IconCache extends Signals.EventEmitter {
    ...
    _markFailed(name, reason) {
        console.warn(`[Home Assistant Tiles] Icon mdi:${name} unavailable: ${reason}`);
